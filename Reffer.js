...
async function showRefer(bot, msg) {
    ...
    try {
        ...
        const botUsername = 'YOUR_BOT_USERNAME'; // আপনার বটের ইউজারনেম এখানে দিন
        const referLink = `https://t.me/${botUsername}?start=ref_${userId}`;

        const bonusPercentage = userData.referBonusPercent || 10; // মাইনিং থেকে কত পার্সেন্ট কমিশন পাবে
